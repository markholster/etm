...
public class AdditionalQueryParameterConverter extends NestedObjectConverter<AdditionalQueryParameter> {

    public AdditionalQueryParameterConverter() {
        super(f -> new AdditionalQueryParameter());
    }
