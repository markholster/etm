...
Both Enterprise Telemetry Monitor and Elasticsearch are capable of running on Kubernetes. Templates of Kubernetes configuration files can be found at the [Jecstar Github Repository](https://github.com/jecstarinnovations/etm/tree/v4.0.0/etm-kubernetes/src/main/kubernetes) of Enterprise Telemetry Monitor.
