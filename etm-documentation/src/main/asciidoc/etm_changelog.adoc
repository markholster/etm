...
* Changes configuration elasticsearch.connectAddresses to a list. This needs to be changed in your etm.yml! For example
...
.. Change the option elasticsearch.connectAddresses to a list. See <<Version 3.0.0>> for an example.
. Start a single {etm} node in condole mode and wait for the data migration to complete.
