...
Special attantion should be paid to the ''Dashboards datasources'' and ''Signal datasources'' attributes. The values of those attributes are not propagated to the users that are member of the group, but are applied to the dashboards and signals that be long to that specific group.
