...
|guiMessionTimeout|30|The timeout of the http sessions in minutes for the GUI.
...
|restProcessorMessionTimeout|5|The timeout of the http sessions in minutes for the REST processor.
