...
When everything is ok, you can access {etm} with a browser by browsing to the following address link:http://127.0.0.1:8080/gui/search/[]. During installation an administrative account is created with the username ''admin'' and the password ''password''.
