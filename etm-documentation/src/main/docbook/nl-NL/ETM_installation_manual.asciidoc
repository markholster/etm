...
Voor de aansluiting van de Messaga Driven Bean op IBM MQ wordt gebruik gemaakt van de http://www-01.ibm.com/support/docview.wss?uid=swg27041968[IBM MQ Resource Adapter]. Deploy
de wmq.jmsra.jar in Wildfly en pas tevens de overige instellingen aan in standalone.xml
