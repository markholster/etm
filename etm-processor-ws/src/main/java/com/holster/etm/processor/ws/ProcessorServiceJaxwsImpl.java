...
@WebService(serviceName="ProcessorService", targetNamespace="http://ws.etm.holster.com/processorservice", portName="ProcessorServicePort", endpointInterface="com.holster.etm.processor.ws.ProcessorService")
